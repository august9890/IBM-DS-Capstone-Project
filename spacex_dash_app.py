...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title='Successful/Failed Launches for this Launch Site')
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        title='Correlation between Payload Mass (kg) and Outcome for All Sites')
        return fig
    else:
        filtered_launchSite = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig = px.scatter(
            filtered_launchSite,
            x='Payload Mass (kg)',
            y='class',
            color='Booster Version Category',
            title='Correlation between Payload Mass (kg) and Outcome for this Launch Site')
        return fig
